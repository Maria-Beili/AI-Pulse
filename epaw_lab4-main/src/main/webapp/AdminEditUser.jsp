...
<div class="main-container">
    <div class="brand-header">
        <h1><span>Admin</span> - Edit User</h1>
        <p>Update account details for any user.</p>
    </div>

    <div class="w3-card-4 auth-card">
        <div class="w3-container brand-title-bg">
            <h2>Edit User</h2>
            <p class="auth-subtitle">Leave password blank to keep the current password.</p>
        </div>

        <form id="adminEditUserForm" action="AdminEditUser" method="POST" enctype="multipart/form-data" class="w3-container w3-padding-24 auth-form">
            ...
            <div class="auth-field">
                ...
                <select class="w3-input w3-border" id="role" name="role">
                    <option value="NOT_REGISTERED" ${user.role == 'NOT_REGISTERED' ? 'selected' : ''}>Not Registered</option>
